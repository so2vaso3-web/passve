    ...
    <footer className={`bg-dark-card border-t border-dark-border mt-16 sm:mt-20 md:mt-24 py-8 sm:py-10 md:py-12 ${hideOnMobile ? "hidden md:block" : ""}`}>
      <div className="container mx-auto px-3 sm:px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            <h3 className="font-heading font-bold text-dark-text mb-4">Về chúng tôi</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/about" className="text-dark-text2 hover:text-neon-green transition-colors">
                  Giới thiệu
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-dark-text2 hover:text-neon-green transition-colors">
                  Điều khoản
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-dark-text2 hover:text-neon-green transition-colors">
                  Chính sách bảo mật
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="font-heading font-bold text-dark-text mb-4">Hỗ trợ</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/help" className="text-dark-text2 hover:text-neon-green transition-colors">
                  Hướng dẫn
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-dark-text2 hover:text-neon-green transition-colors">
                  Liên hệ
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-dark-text2 hover:text-neon-green transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
